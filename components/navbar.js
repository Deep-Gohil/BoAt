        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 d-flex align-items-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/pages/BoAtPersonalisation.html">BoAt Personalisation</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/pages/GiftWithBoAt.html">Gift With BoAt</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/pages/CorporateOrders.html">Corporate Orders</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <li class="nav-item">
              <a class="nav-link btn btn-primary border border-2" href="/pages/signUP.html" >Sign-UP</a> </a>
            </li>
                        <li class="nav-item">
              <a class="nav-link btn btn-primary border border-2" href="/pages/logIn.html" >Log-in</a> </a>
            </li>
                </ul>
